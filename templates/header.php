        ...
        <div class="modal-body p-4 p-md-5">
            ...
            <form action="#" id="loginForm" class="login-form">
                ...
                <div class="password-input-container form-group mb-4">
                    ...
                    <span id="showPasswordToggle" class="password-toggle fas fa-eye"></span>
                </div>
                <div class="form-group mb-4">
                ...
                <div class="form-group d-flex justify-content-between">
                    <div class="opt-login-left">
                        <label class="custom-control fill-checkbox">
                                        <input type="checkbox" name="remember" class="fill-control-input">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body p-4 p-md-5">
            ...
            <form action="#" id="resetForm" class="login-form">
                <div class="form-group mb-4">
        ...
        <div class="text-center">
            <p>Already Have an account? <a href="./registration.php?openModal=true">Login</a></p>
        </div>
      </div>
    </div>
  </div>